    ...
    >
      <div>
        ...
        <ul className="nav flex-column mb-3">
          ...
          <li className="nav-item">
            <NavLink to="/karyawan/data-karyawan" className={linkClass}><FaUsers className="me-2" /> Data Karyawan</NavLink>
          </li>
          <li className="nav-item">
            <NavLink to="/karyawan/keluarga-karyawan" className={linkClass}><FaUserFriends className="me-2" /> Keluarga Karyawan</NavLink>
          </li>
          <li className="nav-item">
            <NavLink to="/karyawan/persetujuan-hrd" className={linkClass}><FaCogs className="me-2" /> Persetujuan HRD</NavLink>
          </li>
          <li className="nav-item">
            <NavLink to="/karyawan/pencairan-keuangan" className={linkClass}><FaWallet className="me-2" /> Pencairan Keuangan</NavLink>
          </li>
        </ul>
      </div>
